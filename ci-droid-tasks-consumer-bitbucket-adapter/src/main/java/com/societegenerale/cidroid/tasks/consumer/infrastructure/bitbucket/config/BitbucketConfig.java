...
public class BitbucketConfig {
    ...
    @Bean
    public SourceControlBulkActionsPerformer remoteForBitbucketBulkActionsWrapper(FeignRemoteForBitbucketBulkActions feignRemoteForBitbucketBulkActions) {

        return new RemoteForBitbucketBulkActionsWrapper(feignRemoteForBitbucketBulkActions);
    }
